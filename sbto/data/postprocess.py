...
def split_x_traj(
    ...
    elif mj_model is None:
        raise ValueError("xml_path or mj_model need to be specified.")
...
def remove_obs_from_data(traj_file_path: str,) -> None:
    remove_field_from_data(traj_file_path, "obs")

def remove_x_from_data(traj_file_path: str,) -> None:
    remove_field_from_data(traj_file_path, "x")
...
def post_process_for_rl(
    ...
    if dst_model_path:
        ...
        data_dict = split_x_traj(x_new_traj, dst_model_path)
    else:
        data_dict = split_x_traj(x_traj, src_model_path)
