...
class ConfigG1RobotObjRef():
    ...
    base_linvel_weight: float = 1.
    base_angvel_weight: float = 1.
    ...
    def __init__(
       ...
       ### SET CONTACT PLAN
        ...
        self.add_state_cost_from_ref(
            "base_linvel",
            quadratic_cost_nb,
            sim.mj_scene.base_v_adr,
            weights=cfg.base_linvel_weight,
        )
        self.add_state_cost_from_ref(
            "base_angvel",
            quadratic_cost_nb,
            sim.mj_scene.base_w_adr,
            weights=cfg.base_angvel_weight,
        )
        self.add_state_cost_from_ref(
            "joint_vel",
            quadratic_cost_nb,
